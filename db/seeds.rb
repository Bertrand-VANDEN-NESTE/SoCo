...
event4 = Event.new(title: "Brunch e-commerce Marseille by Evolutive x Scalapay", date: Date.new(2023, 3, 27), location: "36 Boulevard Charles Livon 13007 Marseille", description: "Sofitel Marseille Vieux-Port - Le 09 mars prochain, Evolutive Group, Scalapay et Bridge vous invitent dans la magnifique ville de Marseille pour un atelier autour du e-commerce suivi d’un délicieux brunch pour échanger entre acteurs du e-commerce marseillais. Le tout dans le somptueux Sofitel Marseille Vieux Port.", capacity: 70, status: "public", tricount: "https://www.tricount.com/fr/creer-des-comptes-nouveau-tricount", password: "123456", user: user4)
...
event5 = Event.new(title: "Demoday Le Wagon", date: Date.new(2023, 3, 17), location: "21 rue Haxo 13001 Marseille", description: "Le Wagon - Pendant ces 9 semaines de bootcamp, nos apprenants ont travaillé dur pour apprendre à coder et gagner une autonomie technique. Ils peuvent aujourd’hui développer des applications web et mobiles de A à Z en Fullstack Rails ! Que vous soyez développeurs, recruteurs, alumnis, que vous cherchiez à apprendre à coder ou bien que vous soyez tout simplement curieux, vous êtes le/la bienvenu.e ! Les places sont limitées, ne tardez pas !", capacity: 40, status: "public", tricount: "https://www.tricount.com/fr/creer-des-comptes-nouveau-tricount", password: "123456", user: user5)
...
event7 = Event.new(title: "Société de Musique de Chambre de Marseille", date: Date.new(2023, 10, 18), location: "27 Boulevard Jean Moulin 13005 Marseille", description: "Auditorium Maurice Toga Faculté de Médecine La Timone - Rejoins-nous pour notre événement Bouge ton Réseau ! Le principe est simple, te permettre de rencontrer un maximum de Bougeuses (membres du réseau) et d'entrepreneur.e.s du département dans une ambiance fun et dynamique ! #inspiration #reseautage #entrepreneuriat", capacity: 120, status: "public", tricount: "https://www.tricount.com/fr/creer-des-comptes-nouveau-tricount", password: "123456", user: user3)
...
event13 = Event.new(title: "Séminaire pop art", date: Date.new(2023, 11, 3), location: "114 Rond-Point-du-Prado 13008 Marseille", description: "Parc Chanot - Pour ce séminaire nous avons décidés de reunir plusieurs artistes du monde entier. Ce rassemblement permet de proumouvoir toute influence artistique que notre mordernité peut connaitre.", capacity: 100, status: "public", tricount: "https://www.tricount.com/fr/creer-des-comptes-nouveau-tricount", password: "123456", user: user3)
